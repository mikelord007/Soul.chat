...
{#if toggleGiftModal}
	...
	<div
		class="fixed z-20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#4F4F4F] border-[3px] border-solid border-[#6E6E6E] w-10/12max-w-[22rem] py-6 px-4 md:px-6 pt-4"
	>
